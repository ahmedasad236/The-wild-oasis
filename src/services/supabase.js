...
export const supabaseUrl = 'https://lzyjwvkzzwhcgayemtvp.supabase.co';
export const supabaseAvatarsURL =
  'https://lzyjwvkzzwhcgayemtvp.supabase.co/storage/v1/object/public/avatars';
